...
import com.spring81.bbs.model.ModelComments;
 ...
 public interface IBoard {
    ...
    public List<ModelArticleImage> getArticleImageList(String boardcd, String searchWord, int start, int end);
    ModelArticleImage getArticleImage(int articleno);
    int insertArticleImage(ModelArticleImage articleImage);
    public int updateArticleImage(ModelArticleImage setValue, ModelArticleImage whereValue);
    public int deleteArticleImage(ModelArticleImage article);
    public ModelArticleImage getNextArticleImage(int articleno, String boardcd, String searchWord);
    public ModelArticleImage getPrevArticleImage(int articleno, String boardcd, String searchWord);
