...
<div id="wrap">
    ...
    <ol>
        ...
        <li><a href="./board/boardview/qna" target="_blank">./board/boardview/qna@Pathvariable을 사용</a></li>
    ...
    <script>    
        ...
        <li><a href="./board/boarddelete" target="_blank">./board/boarddelete 반드시 POST로 만들어야 한다.</a></li>
...
<div id="wrap">
    ...
    <ul>
        ...
        <li><a href="./board/articledelete?boardcd=free&articleno=17&curPage=1&searchWord=" target="_blank">/board/articledelete?boardcd=free&amp;articleno=17&amp;curPage=1&amp;searchWord=  (GET) </a></li>
    </ul>
    <br />
    <hr />
...
public class RestController {
    ...
    public @ResponseBody ModelUser login(@RequestParam("id") String id, @RequestParam("pw") String pw) {
        ...
        <li>댓글용 rest 서비스 만들기
            <ol>
                <li>./rest/service/commentadd    만들기(post) </li>
                <li>./rest/service/commentedit   만들기(post) </li>
                <li>./rest/service/commentdelete 만들기(post)</li>
            </ol>
        </li>
    </ol>  
