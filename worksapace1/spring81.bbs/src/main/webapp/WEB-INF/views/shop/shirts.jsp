...
body,h1,h2,h3,h4,h5,h6,.w3-wide {font-family: "Montserrat", sans-serif;}
 ...
 <script src="/resources/js/jquery-3.1.1.js"></script>
    ...
    $(document).ready(function(event){
        $('#getgood').click(function(event){
            
            //ajax 호출
            if(confirm("상품을 고르시겠습니까?")){
                var boardcd = 'my';
                var title='청바지';
                var content='1000원';
            
            $.ajax({
              url : '/rest/insertgetgood'
             , data: JSON.stringify({ 'boardcd':boardcd, 'title':title })       // 사용하는 경우에는 { data1:'test1', data2:'test2' }
             , type: 'post'       // get, post
             , timeout: 30000    // 30초
      ...
      <div class="w3-container">
         ...
         <img src="/resources/images/cap.jpg" style="width:100%">
          ...
          <div class="w3-display-middle w3-display-hover">
            <button id="getgood" class="w3-button w3-black" onclick="">Buy now <i class="fa fa-shopping-cart"></i></button>
          </div>
        </div>
