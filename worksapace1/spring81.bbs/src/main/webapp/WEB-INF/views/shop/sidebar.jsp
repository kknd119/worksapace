  ...
  <div class="w3-modal-content w3-animate-zoom" style="padding:32px">
    <div class="w3-container w3-white w3-center">
      ...
      <form id="loginForm" action="/user/login" method="post" onsubmit="application/x-www-form-urlencoded">
       ...
       <button type="button" class="w3-button w3-padding-large w3-red w3-margin-bottom" onclick="location.href='http://localhost:8080/user/registerterm'" onclick="document.getElementById('newsletter').style.display='none'">회원가입</button>
      </form>
