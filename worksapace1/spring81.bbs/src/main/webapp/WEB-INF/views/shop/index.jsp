...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    <a href="#" class="w3-bar-item w3-button" onclick="myAccFunc()">셔츠<i class="fa fa-caret-down"></i></a>
    <a href="#" class="w3-bar-item w3-button">바지<i class="fa fa-caret-down"></i></a>
    <a href="#" class="w3-bar-item w3-button">모자<i class="fa fa-caret-down"></i></a>   
    <a href="#" class="w3-bar-item w3-button">신발<i class="fa fa-caret-down"></i></a>
