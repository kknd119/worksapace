            ...
            <div id="bbs">
            	...
            	<div id="gul-content">
                    ...
                    <!-- img 태그의 src 경로는 byte 이미지 가져오는 컨트롤러 호출(/getImageByte) -->
                      ...
                      <hr />
                      <div>
                      <c:if test="${thisArticleImage.imageBase64 != null}">
                      <img src="data:${thisArticleImage.contentType};base64,${thisArticleImage.imageBase64}" style="width: 200px"/>
                      </c:if>
                      </div>
                	...
                	<c:forEach var="article" items="${articleImageList }" varStatus="status">
                     ...
                     <tr>
                		<td style="text-align: center;">
                         <a href="javascript:goView(${article.articleno  })">
                			<c:choose>
