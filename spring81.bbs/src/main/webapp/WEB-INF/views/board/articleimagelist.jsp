...
<head>
    ...
    <script type="text/javascript">
      <!--$(document).ready(function(event){
          $('tr[article]').click(function(event){
              var articleno= $(this).attr('articleno');
              location.href='/board/articleview/${boardcd}/'+articleno + winddow.location.search;
          })
      })-->
    </script>
    <script type="text/javascript">
    ...
    $(document).ready(function(event){
    	$('#bbs tr[articleno]').click(function(event){
    		var articleno =$(this).attr('articleno');
    		window.location.href='/board/articleimageview/${boardcd}/'+articleno;
    	});
			...
			<div id="url-navi">BBS</div>
                ...
                <div id="bbs">
                	...
                	<tr>                       
                        ...
                        <a href="javascript:goView(${article.articleno })">${no - status.index}</td>
                        </a>
                		<td>
